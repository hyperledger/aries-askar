...
use super::{
    error::ErrorHandle, handle::ArcHandle, key::LocalKeyHandle, secret::SecretBuffer,
    tags::EntryTagSet,
};
...
#[no_mangle]
pub extern "C" fn askar_entry_list_count(handle: EntryListHandle, count: *mut i32) -> ErrorHandle {
    catch_err! {
...
#[no_mangle]
pub extern "C" fn askar_string_list_count(
