...
use super::{types::KvTag, KvEntry, KvResult};
...
fn decode_row(key: &IndyWalletKey, row: DbRow) -> KvResult<(i64, KvEntry)> {
...
fn collect_tags(key: &IndyWalletKey, tags: Vec<DbRow>) -> KvResult<BTreeMap<i64, Vec<KvTag>>> {
