...
/**
 * Handles that are not generated by cbindgen
 */
typedef struct SequenceHandle StoreHandle;

typedef struct SequenceHandle SessionHandle;

typedef struct SequenceHandle ScanHandle;
